...
function getConfig() {
  ...
  return {
    ...
    GMAIL_QUERY_MUJI: 'from:netstore@muji.net subject:"ご注文ありがとうございました" newer_than:1m -label:配送カレンダー登録済み',
    GMAIL_QUERY_AMAZON_DELIVERED: 'from:(amazon.co.jp) subject:"配達済み" newer_than:1m -label:配送カレンダー登録済み',
